...
function StringExpression( _string, _global ) constructor {
	...
	static evaluate	= function( _data ) {
		static __evaluate__	= function( _node, _local, _eval_ ) {
			...
			switch( _node.ID ) {
				...
				case FAST_SCRIPT_FLAG.VARIABLE:	return _local[$ _node.number ];
				default:
					return _node.number;
			}
			
		}
		return __evaluate__( __Node, _data, __evaluate__ );
